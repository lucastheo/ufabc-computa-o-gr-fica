...
#include <memory>
#include "../atividade_5_b/openglwigget.h"
...
QT_MOC_LITERAL(1, 13, 15), // "updateHitsLabel"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 9), // "updateGun"
QT_MOC_LITERAL(4, 40, 11), // "updateLevel"
QT_MOC_LITERAL(5, 52, 7) // "animate"

    },
    "OpenGLWigget\0updateHitsLabel\0\0updateGun\0"
    "updateLevel\0animate"
};
...
void OpenGLWigget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateHitsLabel((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->updateGun((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->updateLevel((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (OpenGLWigget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenGLWigget::updateHitsLabel)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (OpenGLWigget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenGLWigget::updateGun)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (OpenGLWigget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenGLWigget::updateLevel)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void OpenGLWigget::updateHitsLabel(QString _t1)
{
...
// SIGNAL 1
void OpenGLWigget::updateGun(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void OpenGLWigget::updateLevel(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
